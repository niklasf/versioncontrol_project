...
$view = new view;
$view->name = 'vc_project_global_commits';
$view->description = 'VersionControl Project Global Commit Log';
...
$handler->override_option('fields', array(
  ...
  'labels' => array(
    'label' => 'List of label this operation is in',
    'alter' => array(
      'alter_text' => 0,
      'text' => '',
      'make_link' => 0,
...
$handler->override_option('fields', array(
  ...
  'nothing' => array(
    'label' => '',
    'alter' => array(
      'text' => '[title]: Commit [revision] on [labels] [attribution]',
      'make_link' => 0,
      'path' => '#',
      'link_class' => 'global-author',
      'alt' => '',
